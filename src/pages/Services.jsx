...
const Services = () => {
  return (
    <div className="w-full bg-gradient-to-br from-[#061d3c] via-[#0f0727] to-[#0f0727] text-white flex justify-center py-20" id="services">
      <div className="flex flex-wrap gap-10 justify-center w-[85%]">
        {service.map((item, index) => (
          ...
          >
            ...
            <h2 className="text-md font-bold pb-2 tracking-wide">{item.name}</h2>
